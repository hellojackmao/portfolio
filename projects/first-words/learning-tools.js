...
window.FirstWordsTools = (() => {
  ...
  function finishLesson(index, onFinish){
    ...
    const destination=moment?'<div class="destination-next"><p class="learning-progress">Optional · One moment in '+place[1]+'</p><a class="btn ghost" href="practice.html?place='+place[0]+'&amp;moment='+moment[0]+'">'+moment[1]+'</a><p class="reference-note">Use a familiar phrase in a short activity. The full outing can wait.</p></div>':'';
